...
#include <qglobal.h>
#include <qfsource_file=engine.h>
...
#define SBK_QFsource_file=ENGINE_IDX                                        54
...
template<> inline PyTypeObject* SbkType< ::QFsource_file=Engine >() { return reinterpret_cast<PyTypeObject*>(SbkPySide_QtCoreTypes[SBK_QFsource_file=ENGINE_IDX]); }
