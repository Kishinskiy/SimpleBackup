...
class MainWindow(QtGui.QMainWindow):
    ...
    def openIniFile(self):
        file_name, _  = QtGui.QFileDialog.getOpenFileName(self, "Open INI File",
                '', "INI Files (*.ini *.conf)")
    ...
    def openPropertyList(self):
        ...
        if file_name:
            settings = QtCore.QSettings(file_name, QtCore.QSettings.NativeFormat)
            self.setSettingsObject(settings)
            self.fallbacksAct.setEnabled(False)
    ...
    def updateLocationsTable(self):
        ...
        for i in range(2):
            ...
            for j in range(2):
                ...
                item0.setText(settings.file_name())
