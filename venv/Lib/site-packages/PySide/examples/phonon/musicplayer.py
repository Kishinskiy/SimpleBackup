...
class MainWindow(QtGui.QMainWindow):
    ...
    def metaStateChanged(self, newState, oldState):
        ...
        if title=="":
            title = self.metaInformationResolver.currentSource().file_name()
    ...
    def setupActions(self):
        ...
        self.addestination_filesAction = QtGui.QAction(self.tr("Add &Files"), self)
        self.addestination_filesAction.setShortcut(self.tr("Ctrl+F"))
        ...
        self.connect(self.addestination_filesAction, QtCore.SIGNAL('triggered()'),
                self.addestination_files)
    ...
    def setupMenus(self):
        ...
        fileMenu.addAction(self.addestination_filesAction)
