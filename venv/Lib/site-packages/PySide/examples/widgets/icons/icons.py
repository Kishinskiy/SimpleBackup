...
class MainWindow(QtGui.QMainWindow):
    ...
    def changeIcon(self):
        ...
        for row in range(self.imagesTable.rowCount()):
            ...
            if item0.checkState() == QtCore.Qt.Checked:
                ...
                file_name = item0.data(QtCore.Qt.UserRole)
    ...
    def addImage(self):
        file_names, filters = QtGui.QFileDialog.getOpenFileNames(self, "Open Images",
        ...
        for file_name in file_names:
            ...
            imageName = QtCore.QFileInfo(file_name).baseName()
            item0 = QtGui.QTableWidgetItem(imageName)
            item0.setData(QtCore.Qt.UserRole, file_name)
            ...
            if self.guessModeStateAct.isChecked():
                ...
                elif '_dis' in file_name:
                    item1.setText("Disabled")
                elif '_sel' in file_name:
