...
class TabDialog(QtGui.QDialog):
    def __init__(self, file_name, parent=None):
        ...
        fileInfo = QtCore.QFileInfo(file_name)
...
class GeneralTab(QtGui.QWidget):
    def __init__(self, fileInfo, parent=None):
        ...
        file_nameLabel = QtGui.QLabel("File Name:")
        file_nameEdit = QtGui.QLineEdit(fileInfo.file_name())
        ...
        mainLayout = QtGui.QVBoxLayout()
        mainLayout.addWidget(file_nameLabel)
        mainLayout.addWidget(file_nameEdit)
