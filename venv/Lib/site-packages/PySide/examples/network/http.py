...
class HttpWindow(QtGui.QDialog):
    ...
    def downloadestination_file(self):
        ...
        if QtCore.QFile.exists(file_name):
            QtGui.QMessageBox.information(self, self.tr("HTTP"), self.tr(
                                          ...
                                          "in the current directory.") % (file_name))
            return
        ...
        self.progressDialog.setLabelText(self.tr("Downloading %s.") % (file_name))
    ...
    def httpRequestFinished(self, requestId, error):
        ...
        if error:
            ...
            file_name = QtCore.QFileInfo(QtCore.QUrl(self.urlLineEdit.text()).path()).file_name()
            self.statusLabel.setText(self.tr("Downloaded %s to current directory.") % (file_name))
