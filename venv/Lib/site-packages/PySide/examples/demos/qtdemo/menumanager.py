...
class MenuManager(QtCore.QObject):
    ...
    def resolveDir(self, name):
        ...
        file_name = self.info[name]['filename']
    ...
    def resolveExeFile(self, name):
        ...
        pyFile = QtCore.QFile(dir.path() + '/' + file_name + '.py')
        if pyFile.exists():
            return pyFile.file_name()

        pywFile = QtCore.QFile(dir.path() + '/' + file_name + '.pyw')
        if pywFile.exists():
            return pywFile.file_name()
    ...
    def resolveDocUrl(self, name):
        ...
        if category == 'demos':
            return self.helpRootUrl + 'demos-' + file_name + '.html'
        else:
            return self.helpRootUrl + dirName.replace('/', '-') + '-' + file_name + '.html'
    ...
    def getImage(self, name):
        ...
        if not imageName:
            if category == 'demos':
                imageName = file_name + '-demo.png'
            else:
                imageName = file_name + '-example.png'
