...
<categories name="PyQt Examples and Demos">
  ...
  <category dirname="effects" name="Graphics Effects">
    <example filename="lighting" name="Lighting and Shadows" />
  </category>
  <category dirname="graphicsview" name="Graphics View">
    <example filename="anchorlayout" name="Anchor Layout" />
